...
function navInsert() {
    let navHtml = '<nav><div class="innerNav"><a id="logo" href="/Marialface/index.html"><i id="logo" class="fa-brands fa-pagelines"></i></a><button id="hamburger" class="btn" onclick="navToggle()"><i id="iham" class="fa-solid fa-bars"></i><i id="icross" class="fa-solid fa-xmark hidden"></i></button></div><ul id="navMenu" class="animate__animated hidden"><li><a id="homeLink" href="/Marialface/index.html">Home</a></li><li><a href="/Marialface/pages/ABCulinaria/ABCulinaria.html">ABCulinária</a></li><li><a href="/Marialface/pages/Perguntas_Frequentes/Perguntas_Frequentes.html">Perguntas Frequentes</a></li><li><a href="/Marialface/pages/Receitas/Receitas.html">Receitas</a></li></ul></nav>';
